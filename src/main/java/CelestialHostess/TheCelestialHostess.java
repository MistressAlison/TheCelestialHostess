...
import static CelestialHostess.MainModfile.*;

public class TheCelestialHostess extends CustomPlayer {
    ...
    static final String ID = makeID(TheCelestialHostess.class.getSimpleName());
    ...
    public AbstractCard.CardColor getCardColor() {
        return Enums.CELESTIAL_CHARDONNAY_COLOR;
    }

    @Override
    public Color getCardTrailColor() {
        return MainModfile.CELESTIAL_CHARDONNAY_COLOR.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheCelestialHostess(name, chosenClass);
    }
    ...
    public Texture getCutsceneBg() {
        return ImageMaster.loadImage("CelestialHostessResources/images/panels/bkg.png");
    }

    @Override
    public List<CutscenePanel> getCutscenePanels() {
        List<CutscenePanel> panels = new ArrayList<>();
        panels.add(new CutscenePanel("CelestialHostessResources/images/panels/HeartPanel.png", "UNLOCK_PING"));
        return panels;
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_CELESTIAL_HOSTESS;
        @SpireEnum(name = "CELESTIAL_CHARDONNAY_COLOR")
        public static AbstractCard.CardColor CELESTIAL_CHARDONNAY_COLOR;
        @SpireEnum(name = "CELESTIAL_CHARDONNAY_COLOR")

...
import static CelestialHostess.MainModfile.makeImagePath;
import static CelestialHostess.MainModfile.modID;
import static CelestialHostess.util.Wiz.atb;
import static CelestialHostess.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        ...
        FlavorText.AbstractCardFlavorFields.boxColor.set(this, mix(BLACK.cpy(), MainModfile.CELESTIAL_CHARDONNAY_COLOR.cpy()));
